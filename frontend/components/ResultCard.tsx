export default function ResultCard({ result }: any) {
  ...
  return (
    <div className="mt-8 pt-6 border-t border-gray-200 transition-all duration-300">
      {/* score */}
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-green-50 p-4 rounded">
          <h3 className="font-semibold mb-2 text-black">Matched Skills</h3>
        ...
        <div className="bg-red-50 p-4 rounded">
          <h3 className="font-semibold mb-2 text-black">Missing Skills</h3>
          <ul className="list-disc ml-5 text-sm space-y-1">
